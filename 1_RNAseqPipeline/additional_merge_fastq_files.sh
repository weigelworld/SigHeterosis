#!/bin/bash
#this script merge an additional lane of data with previously merged fastqs
PROJECT=$1
mergefileprefix=$2
trimmer=$3
lanenum=$4
...
#		continue
#	fi
	matchmergefile="/ebio/abt6_projects7/SHB2/data/run189/merged_reads/${samplename}merge_R1.fastq"
	echo $matchmergefile
	cp $matchmergefile .
	chmod a+wx ${samplename}merge_R1.fastq
	cat $line $matchmergefile > ./merged_reads/${samplename}9lane_merge.R1.fastq
	rm ${samplename}merge_R1.fastq
done
